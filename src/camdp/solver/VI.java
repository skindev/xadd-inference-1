...
//    private static final Logger LOGGER = Logger.getLogger(Thread.currentThread().getStackTrace()[0].getClassName());
    private static final Logger LOGGER = Logger.getLogger("camdp.solver.vi");
...
//            debugOutput.println("Starting " + solveMethod + " solution, Max #Iterations = " + nIter + "\n");
        ...
        LOGGER.info("Starting " + solveMethod + " solution, Max #Iterations = " + nIter);
        ...
        while (curIter < nIter) {
            ...
            //Approximation at the end of Iter
            checkLinearApprox();
            ...
            LOGGER.fine("Iter:" + curIter + " Complete");
            LOGGER.fine("Value DD:" + valueDD + " Nodes= " + solutionNodeList[curIter] + " Time =" + solutionTimeList[curIter]);

            if (CALCULATE_GREEDY_ACTION)
                LOGGER.fine("Greedy Action =" + getGreedyAction(valueDD, mdp._initialS));

            if (mdp._initialS != null)
                LOGGER.fine("Initial State Value = " + solutionInitialSValueList[curIter]);
...
//                    debugOutput.println("\nVI: Converged to solution early,  at iteration " + curIter);
                ...
                LOGGER.info("VI: Converged to solution early,  at iteration " + curIter);
                break;
            }
        }
        ...
        LOGGER.exiting(Thread.currentThread().getStackTrace()[0].getClassName(), "solve", finalIter);
        return finalIter;
    }
...
//            mdp.displayGraph(localQ, "LocalQ");
    ...
    private void bellmanBackup() {
        ...
        for (Map.Entry<String, CAction> me : mdp._hmName2Action.entrySet()) {
            ...
            LOGGER.fine("Bellman Backup " + curIter + " Action " + me.getKey() + " Regr Time = " + CAMDP.getElapsedTime(RUN_DEPTH));
...
//                debugOutput.println("Bellman Backup " + curIter + " Action " + me.getKey() + " Regr Time = " + CAMDP.getElapsedTime(RUN_DEPTH));
                ...
                if (mdp._initialS != null) {
                    ...
                    LOGGER.fine("InitialSValue for Action " + me.getValue()._sName + " = " + iniSVal);
//                    debugOutput.println("InitialSValue for Action " + me.getValue()._sName + " = " + iniSVal);
    ...
    public int regress(int vfun, CAction a, boolean regressCont) {
        ...
        LOGGER.fine("REGRESSING ACTION " + a._sName + " Iter " + curIter);
...
//            debugOutput.println("REGRESSING ACTION " + a._sName + " Iter " + curIter);
        ...
        if (mdp._bdDiscount.doubleValue() != 1) {
            LOGGER.finer("Warning: Using discount on Finite Horizon");
//            debugOutput.println("Warning: Using discount on Finite Horizon");
    ...
    public int regressCVars(int q, CAction a, String var) {
        ...
        LOGGER.fine("Integrating out: " + var + " at regression of " + a._sName + "^" + curIter);
