...
data = pd.read_table('/Users/skin/repository/xadd-inference-1/src/cmomdp/domain/aaai2017/results/robot1d_irl_value_function_data.txt', names=['x', 'y', 'z'])
