...
MAINJAVA=$MAIN".java"
echo javac -source 1.6 -target 1.6 -d $BIN_DIR -cp $CLASSPATH $MAINJAVA
javac -source 1.6 -target 1.6 -d $BIN_DIR -cp $CLASSPATH $MAINJAVA  #comment to debug compilation
cd $ORI
